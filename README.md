...
students summon it (in Egyptian Arabic and English), the four parts it is built from, three
short code snippets, and the engineering lessons worth passing on — including why it has no
vector database, why real-time listeners came out both cheaper and fresher than polling, and
